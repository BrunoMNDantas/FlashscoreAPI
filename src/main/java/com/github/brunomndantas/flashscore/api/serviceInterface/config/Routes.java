...
public class Routes {
    ...
    public static final String REGIONS_ROUTE = "/regions";
    public static final String REGION_ROUTE = REGIONS_ROUTE + "/{sportId}/{regionId}";

    public static final String COMPETITIONS_ROUTE = "/competitions";
    public static final String COMPETITION_ROUTE = COMPETITIONS_ROUTE + "/{sportId}/{regionId}/{competitionId}";

    public static final String SEASONS_ROUTE = "/seasons";
    public static final String SEASON_ROUTE = SEASONS_ROUTE + "/{sportId}/{regionId}/{competitionId}/{seasonId}";
