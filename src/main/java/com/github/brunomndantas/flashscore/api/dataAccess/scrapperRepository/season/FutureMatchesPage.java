...
public class FutureMatchesPage extends FlashscorePage {
    ...
    public FutureMatchesPage(WebDriver driver, SeasonKey seasonKey) {
        super(driver, FlashscoreURLs.getSeasonFutureMatchesURL(seasonKey));
